<?php
// Course 99 (Enhancing Recovery Housing Financial Stability & Resiliency
// webinar), Jennifer 8-29: add the presentation slides PDF as a
// "Presentation Slides" resource right after the Webinar Transcript (cmid
// 423), same settings as the other webinar shells (embed, no intro, no
// completion). Idempotent by name. Expects the PDF at /tmp/erh-slides.pdf.
// Usage: sudo -u daemon php addslides99.php [--dry]
...
$COURSEID = 99;
$AFTER_CMID = 423;                       // Webinar Transcript
$NAME = 'Presentation Slides';
$SRC = '/tmp/erh-slides.pdf';
$FILENAME = 'Enhancing Recovery Housing Financial Stability and Resiliency - Slides.pdf';
...
mtrace("would add '$NAME' (" . filesize($SRC) . " bytes) after cmid $AFTER_CMID");
if ($DRY) { exit(0); }
...
$d->files = $draftid;
$d->display = RESOURCELIB_DISPLAY_EMBED;   // matches the other webinars' Slides resources
