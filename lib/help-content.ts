...
export const HELP_TOPICS: HelpTopic[] = [
  ...
  },
  {
    ...
    description:
      'Fletch is the library’s AI assistant — the owl on the Ask Fletch pill in the bottom-right corner of the library pages. Describe what you’re working on in plain language and Fletch replies with the resources that fit, as clickable cards.',
    quickStart: [
