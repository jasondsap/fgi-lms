 ...
 * `registerAction` refuses to create accounts — so only people who already
 * hold a username + password can get in. Flip to `true` to reopen signup.
 *
 ...
 */
export const SELF_REGISTRATION_OPEN = false;
