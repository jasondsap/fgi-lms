...
// Category card images — used as thumbnail fallback when no specific image exists
const CATEGORY_CARD_IMAGE: Record<string, string> = {
  ...
  course:        '/images/category-cards/toolkit.png', // fallback until course card exists
};
...
export default function ResourceCard({ resource }: Props) {
  ...
  const shortLabel   = typeLabel.split(' / ')[0]; // "Course" not "Course / Training"
      ...
      >
        ...
        <div style={{ position: 'relative', height: '160px', flexShrink: 0 }}>
          {thumbnailSrc ? (
            ...
            /* solid color fallback if no image at all */
            <div style={{
          ...
          {/* Type badge — bottom-left, matching mockup */}
          <div style={{
