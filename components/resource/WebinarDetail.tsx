        ...
        {/* ── Presenters, CE panels, and the action rail ── */}
          <div className="shell-grid__body" style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
            ...
            {/* Featured book / sponsor card (8-30-26: Jay Davidson's "Miracle on
                ...
                fields; renders wherever they are set on a webinar row. Below the
                bio, book image at 90px (8-31-26, Jason: −40%). */}
            {resource.sponsor_text && (
              <div style={{
                background: '#ffffff', border: '1px solid var(--border-color)',
                borderRadius: '8px', padding: '1.5rem', display: 'grid',
                gridTemplateColumns: resource.sponsor_logo_url ? '1fr 90px' : '1fr',
                ...
                {resource.sponsor_logo_url && (
                  <a href={resource.sponsor_url ?? '#'} target="_blank" rel="noopener noreferrer">
                    ...
                    <img
                      ...
                      style={{ width: '100%', maxWidth: '90px', height: 'auto', display: 'block', margin: '0 auto', borderRadius: '4px', boxShadow: '0 2px 10px rgba(0,0,0,0.18)' }}
                    />
                  </a>
                )}
              </div>
